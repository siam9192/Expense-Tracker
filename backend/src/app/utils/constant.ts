...
export const DEFAULT_CATEGORIES = [
  // INCOME
  {
    ...
    is_hidden: false,
    description:
      "Salary represents the fixed or variable income that a user earns from their regular employment. It is typically received monthly or biweekly and forms the primary source of income for most users, helping to manage their financial stability and budgeting plans effectively.",
  },
  {
    ...
    is_hidden: false,
    description:
      "Business or Self-Employment income includes all earnings generated from independent work, freelancing, or running a personal business. This category helps users track entrepreneurial income separately from regular salary and understand their total earnings more accurately for tax and financial planning purposes.",
  },
  {
    name: "Gift",
    type: "INCOME",
    ...
    is_hidden: false,
    description:
      "Gift income represents any money received as gifts from friends, family, or others. Tracking gift income separately allows users to distinguish between earned and unearned money, providing a clearer picture of disposable income and helping to plan for savings and personal expenses.",
  },
  ...
  // EXPENSE
  {
    ...
    is_hidden: false,
    description:
      "Food & Dining includes all expenses related to meals, groceries, restaurants, cafes, and snacks. Tracking this category allows users to monitor their spending on everyday nutrition, plan budgets effectively, and make informed choices to maintain a balanced financial lifestyle.",
  },
  {
    name: "Transport",
    type: "EXPENSE",
    ...
    is_hidden: false,
    description:
      "Transport expenses cover costs related to commuting, public transportation, fuel, vehicle maintenance, ride-sharing services, and parking. Monitoring this category helps users understand their mobility-related spending, optimize travel costs, and plan budgets for transportation more efficiently.",
  },
  {
    name: "Shopping",
    type: "EXPENSE",
  ...
  },
  {
    ...
    is_hidden: false,
    description:
      "Bills & Utilities encompass recurring household and personal expenses such as electricity, water, gas, internet, phone bills, and other necessary services. Monitoring this category helps users plan fixed monthly expenses, avoid overdue payments, and maintain financial stability through effective budgeting.",
  },
  {
    name: "Entertainment",
    type: "EXPENSE",
  ...
  // SAVING (System Categories)
  {
    ...
    is_hidden: true,
    description:
      "Goal Deposit is a system category used internally to track funds transferred into a user's savings goal. It allows the app to manage dedicated savings separately from the main available balance, ensuring accurate tracking of saved money, financial goals, and progress toward long-term objectives without affecting regular income or expenses.",
  },
  {
