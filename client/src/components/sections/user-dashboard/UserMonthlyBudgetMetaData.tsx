      ...
      <div className="p-8 rounded-2xl space-y-6  transition-all">
        ...
        <div className="grid grid-cols-2 divide-x divide-neutral-content text-center">
          ...
          <div className="px-4">
            <p className="text-sm text-neutral flex items-center justify-center gap-1">
              <Target size={14} className="text-info" /> {t("budgetLimit")}
            </p>
          ...
          <div className="px-4">
            <p className="text-sm text-neutral flex items-center justify-center gap-1">
              <TrendingDown size={14} className="text-error" /> {t("spent")}
            </p>
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm font-medium">
            <span className="text-neutral-content">{t("budgetUsage")}</span>
            <span
              className={`${
                spentPercent > 80
                  ? "text-error"
            ...
            >
              <CountUp start={0} end={spentPercent} duration={2} />% {t("used")}
            </span>
          </div>
          <progress
